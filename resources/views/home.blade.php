...
<section id="secHome">
    <div class="wrapper">
        <div class="container">
            ...
            <div class="scm">
                <ul>
                    <li><a href="mailto:fiqihvandy@gmail.com?subject=Hello%20Fiqih&body=Good%20Job!!" target="_blank"><i class="fa fa-google mx-2"></i></a></li>
                    <li><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A//web.facebook.com/fiqih.fvf" target="_blank"><i class="fa fa-facebook-official mx-2"></i></a></li>
                    <li><a href="https://www.instagram.com/fiqihvandy/" target="_blank"><i class="fa fa-instagram mx-2"></i></a></li>
                    <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A//www.linkedin.com/in/fiqih-vandy-b160371b3/&title=Hello%20Fiqih&summary=Good%20Job!!&source=" target="_blank"><i class="fa fa-linkedin mx-2"></i></a></li>
                </ul>
            </div>
            <div class=" foot">
                <p class="mb-0 ml-1">Copyright @ 2021 FiqihVandy, All Rights Reserved</p>
